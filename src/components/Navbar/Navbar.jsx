            ...
            >
              ...
              <div className="space-x-6">
                <button
                  ...
                  className="text-gray-800 dark:text-white focus:outline-none focus:ring-gray-800"
                >
                  <svg
                    className="fill-stroke"
                    width={16}
                ...
                >
                  ...
                  <span className="absolute top-3 px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">
                    {totalItems}
                  </span>
                </a>
              </div>
            ...
            <div className="dark:bg-gray-900 bg-gray-50 px-6 py-9">
              <div className="container mx-auto flex items-center justify-between">
                ...
                <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                  ...
                  <li>
                    <a
                      href="/category/cat_gnZO5kZ06o7MNq"
                      className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-gray-800 hover:underline"
                    >
                      Gaming Accesories
                    </a>
                ...
                <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                  <div className="hidden lg:flex items-center">
                    ...
                    >
                      <AiOutlineShoppingCart
                        ...
                        color="black"
                      />
                      <span className="absolute top-6 px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">
                        {totalItems}
                      </span>
                    </a>
                    <input
                  ...
                  <div className="flex lg:hidden">
                    <button
                      ...
                      className="text-black dark:text-white dark:hover:text-gray-300 hidden md:flex focus:outline-none rounded focus:ring-gray-600"
                    >
                      <svg
                        className="fill-stroke"
                        width={24}
                    ...
                    <a
                      href="/cart"
                      aria-label="go to cart"
                      className="text-black mt-1 mr-4 dark:text-white dark:hover:text-gray-300 md:hidden focus:outline-none rounded focus:ring-gray-600"
                    >
                      <svg
                        className="fill-stroke"
                        width={18}
                    ...
                    <button
                      ...
                      className="text-black dark:text-white dark:hover:text-gray-300 md:hidden focus:outline-none rounded focus:ring-gray-600"
                    >
                      <svg
                        className="fill-stroke"
                        width={24}
            ...
            >
              <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 p-4">
                ...
                <button
                  ...
                  className="focus:outline-none rounded focus:ring-gray-600"
                >
                  <svg
                    className="fill-stroke text-gray-800 dark:text-white"
                    width={16}
